    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="col-auto">
            <h4 class="mb-2">Comissão de Verificação de Óbito.</h4>
          </div>
      ...
      <div class="container-fluid">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="taxa-mort-fetal-tab" data-bs-toggle="pill" data-bs-target="#taxa-mort-fetal" type="button" role="tab" aria-controls="taxa-mort-fetal" aria-selected="true" title="Pronto atendimento médico">Taxa de óbito fetal</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="taxa-mort-geral-tab" data-bs-toggle="pill" data-bs-target="#taxa-mort-geral" type="button" role="tab" aria-controls="taxa-mort-geral" aria-selected="false" title="Triagem">Taxa de mortalidade geral</button>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="taxa-mort-fetal" role="tabpanel" aria-labelledby="taxa-mort-fetal-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="taxaMortFetal">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial7" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal7" />
                    </div>
                  ...
                  <div class="chart">
                    <div id="chartTaxaMortalidadeFetal" style="width: 100%; height: 417px;"></div>
                  </div>

                </div>
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise7">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise7" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <label for="planoAcaoResult7">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult7" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="taxa-mort-geral" role="tabpanel" aria-labelledby="taxa-mort-geral-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="taxaMortGeral">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial8" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal8" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                  ...
                  <div class="chart">
                    <div id="chartTaxaMortalidadeGeral" style="width: 100%; height: 417px;"></div>
                  </div>

                </div>
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise8">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise8" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <label for="planoAcaoResult8">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult8" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="taxaMortNeo">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial9" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal9" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise9">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise9" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <label for="planoAcaoResult9">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult9" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                      ...
                      <form id="formAnalise">
                        <div class="row">
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='7' class="form-control" id="solicitacaoTransf" name="solicitacaoTransf" hidden>
                          </div>
                          <div class="col-4">
                          </div>
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='7' class="form-control" id="solicitacaoTransfId" name="solicitacaoTransfId" hidden>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-12">
                      ...
                      <form id="formAnaliseAgencia">
                        <div class="row">
                          <div class="col-4 mt-2">
                            <label for="mesAno">Mês e ano selecionado:</label>
                            <input type="text" class="form-control" id="mesAno" name="mesAno" readonly>
                            <input type="text" value='7' class="form-control" id="solicitacaoTransfIdEdit" name="solicitacaoTransfIdEdit" hidden>
                          </div>
                          <div class="col-4 mt-2">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-12">
                    <form id="formRelatorioSolicTransf">
                      ...
                      <div class="form-group">
                        <input type="text" value='7' class="form-control" id="tela" name="tela" hidden>
                      </div>
                      <div class="form-group">
