    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="col-auto">
            <h4 class="mb-2">Partos Normal</h4>
          </div>
      ...
      <div class="container-fluid">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="perc-amamenta-hora-vida-norm-tab" data-bs-toggle="pill" data-bs-target="#perc-amamenta-hora-vida-norm" type="button" role="tab" aria-controls="perc-amamenta-hora-vida-norm" aria-selected="true" title="Percentual de amamentação 1° hora de vida">Amamentação 1ª hora de vida</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="perc-contato-pele-norm-tab" data-bs-toggle="pill" data-bs-target="#perc-contato-pele-norm" type="button" role="tab" aria-controls="perc-contato-pele-norm" aria-selected="false" title="Percentual contato pele a pele">Contato pele a pele</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="perc-prematuridade-norm-tab" data-bs-toggle="pill" data-bs-target="#perc-prematuridade-norm" type="button" role="tab" aria-controls="perc-prematuridade-norm" aria-selected="false" title="Prematuridade">Prematuridade</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="perc-reanimacao-neo-norm-tab" data-bs-toggle="pill" data-bs-target="#perc-reanimacao-neo-norm" type="button" role="tab" aria-controls="perc-reanimacao-neo-norm" aria-selected="false" title="Prematuridade">Reanimação neo</button>
          </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="perc-amamenta-hora-vida-norm" role="tabpanel" aria-labelledby="perc-amamenta-hora-vida-norm-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="percAmamentaHoraN">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial14" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal14" />
                    </div>
                  ...
                  <div class="chart">
                    <div id="chartPercAmamentaHoraVidaN" style="width: 100%; height: 417px;"></div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise14">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise14" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <label for="planoAcaoResult14">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult14" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="perc-contato-pele-norm" role="tabpanel" aria-labelledby="perc-contato-pele-norm-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="percContatoPeleN">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial15" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal15" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                  ...
                  <div class="chart">
                    <div id="chartPercContatoPeleN" style="width: 100%; height: 417px;"></div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise15">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise15" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <label for="planoAcaoResult15">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult15" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="perc-prematuridade-norm" role="tabpanel" aria-labelledby="perc-prematuridade-norm-tab">
            <div div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="percPrematuridadeN">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial16" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal16" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise16">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise16" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <label for="planoAcaoResult16">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult16" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="perc-reanimacao-neo-norm" role="tabpanel" aria-labelledby="perc-reanimacao-neo-norm-tab">
            <div div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="percReanimacaoN">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial17" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal17" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise17">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise17" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <label for="planoAcaoResult17">Plano de ação</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult17" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                      ...
                      <form id="formAnalise">
                        <div class="row">
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='14' class="form-control" id="solicitacaoTransf" name="solicitacaoTransf" hidden>
                          </div>
                          <div class="col-4">
                          </div>
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='14' class="form-control" id="solicitacaoTransfId" name="solicitacaoTransfId" hidden>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-12">
                      ...
                      <form id="formAnaliseAgencia">
                        <div class="row">
                          <div class="col-4 mt-2">
                            <label for="mesAno">Mês e ano selecionado:</label>
                            <input type="text" class="form-control" id="mesAno" name="mesAno" readonly>
                            <input type="text" value='14' class="form-control" id="solicitacaoTransfIdEdit" name="solicitacaoTransfIdEdit" hidden>
                          </div>
                          <div class="col-4 mt-2">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-12">
                    <form id="formRelatorioSolicTransf">
                      ...
                      <div class="form-group">
                        <input type="text" value='14' class="form-control" id="tela" name="tela" hidden>
                      </div>
                      <div class="form-group">
