    ...
    "1" => [
        "dashboard" => [
            ...
            "subItems" => [
                ...
                "CVO" => ["url" => "../pages/dashboardCvo.php", "icon" => "ni ni-chart-bar-32"],
                "Emergência" => ["url" => "../pages/dashoardEmergencia.php", "icon" => "ni ni-chart-bar-32"],
                ...
                "Partos Cesárea" => ["url" => "../pages/dashboardPartosCesarea.php", "icon" => "ni ni-chart-bar-32"],
                "Partos Normal" => ["url" => "../pages/dashboardPartosNormal.php", "icon" => "ni ni-chart-bar-32"],
                "Recepção" => ["url" => "../pages/dashboardRecepcao.php", "icon" => "ni ni-chart-bar-32"],
                "Obstetrícia" => ["url" => "../pages/dashboardObstetra.php", "icon" => "ni ni-chart-bar-32"],
            ]
        ],
        ...
        "Nir-Eletivas" => ["label" => "Nir Eletivas", "url" => "../pages/nir.php", "icon" => "fas fa-folder-open", "subIt ems" => []],
        ...
        "gestaoPessoas" => ["label" => "Departamento Pessoal", "url" => "../pages/gestaoPessoas.php", "icon" => "fas fa-user", "subItems" => []],
