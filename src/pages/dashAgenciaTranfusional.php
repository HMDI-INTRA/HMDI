    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="transRealTurno-dash-tab" data-bs-toggle="pill" data-bs-target="#transRealTurno-dash" type="button" role="tab" aria-controls="transRealTurno-dash" aria-selected="false" title="Transfusões realizadas por turno">Transfusões solicitadas</button>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="percSolicTrans-dash" role="tabpanel" aria-labelledby="percSolicTrans-dash-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="percSolicTrasnf">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial1" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal1" />
                    </div>
          ...
          <div class="tab-pane fade" id="transRealTurno-dash" role="tabpanel" aria-labelledby="transRealTurno-dash-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="transRealTurno">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial2" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal2" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise2">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise2" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <label for="planoAcaoResult2">Plano de acão</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult2" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="tempMedioTrans-dash" role="tabpanel" aria-labelledby="tempMedioTrans-dash-tab">
            <div div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="tempMedioTransf">
                  <div class="row">
                    <div class="col-2">
                      <label for="dt-inicial" class="form-label">Data inicial:</label>
                      <input type="date" name="dtInicial" class="form-control dtInicial3" />
                    </div>
                    <div class="col-2">
                      <label for="dt-final" class="form-label">Data final:</label>
                      <input type="date" name="dtFinal" class="form-control dtFinal3" />
                    </div>
                    <div class="col-2 mt-4 p-1">
                      <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                    </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="tableAnalise3">Análise</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="tableAnalise3" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <label for="planoAcaoResult3">Plano de acão</label>
                    <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                      <div style="overflow-x: auto;">
                        <table id="planoAcaoResult3" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                      </div>
                    </div>
                  </div>
                      ...
                      <form id="formAnalise">
                        <div class="row">
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='1' class="form-control" id="solicitacaoTransf" name="solicitacaoTransf" hidden>
                          </div>
                          <div class="col-4">
                          </div>
                          <div class="col-4 mt-2">
                            ...
                            <input type="text" value='1' class="form-control" id="solicitacaoTransfId" name="solicitacaoTransfId" hidden>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-12">
                      ...
                      <form id="formAnaliseAgencia">
                        <div class="row">
                          <div class="col-4 mt-2">
                            <label for="mesAno">Mês e ano selecionado:</label>
                            <input type="text" class="form-control" id="mesAno" name="mesAno" readonly>
                            <input type="text" value='1' class="form-control" id="solicitacaoTransfIdEdit" name="solicitacaoTransfIdEdit" hidden>
                          </div>
                          <div class="col-4 mt-2">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-12">
                    <form id="formRelatorioSolicTransf">
                      ...
                      <div class="form-group">
                        <input type="text" value='1' class="form-control" id="tela" name="tela" hidden>
                      </div>
                      <div class="form-group">
