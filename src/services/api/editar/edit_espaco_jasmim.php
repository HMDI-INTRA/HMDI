...
try {
    if ($conn) {
        if (!empty($dados['nr_atendimento'])) {
            ...
            if (!empty($dados['feto'])) {
                $campos_para_atualizar[] = 'feto = :feto';
                $parametros[':feto'] = $dados['feto'];
            }
            ...
            if (!empty($dados['braden_morse'])) {
                $campos_para_atualizar[] = 'braden_morse = :braden_morse';
                $parametros[':braden_morse'] = $dados['braden_morse'];
            }
            ...
            if (!empty($dados['ds_transfusao']) || $dados['ds_transfusao']) {
            ...
            if (!empty($dados['ds_transfusaoRn']) || $dados['ds_transfusaoRn']) {
            ...
            if (!empty($dados['ds_alergiasRn']) || $dados['ds_alergiasRn']) {
                $campos_para_atualizar[] = 'ds_alergiasRn = :ds_alergiasRn';
                $parametros[':ds_alergiasRn'] = $dados['ds_alergiasRn'];
            }
            if (!empty($dados['ds_recomendacoesRn']) || $dados['ds_recomendacoesRn']) {
            ...
            if (!empty($dados['cd_setor_atendimento']) || $dados['cd_setor_atendimento']) {
