...
try {
    // Query para buscar os dados da tabela "computadores"
    $query = "SELECT * FROM cadastros.computadores";
    ...
    // Converte o array em formato JSON
    $json = json_encode($computadores, JSON_UNESCAPED_UNICODE); // Use JSON_UNESCAPED_UNICODE
