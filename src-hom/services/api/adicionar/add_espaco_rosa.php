...
try {
    if ($conn) {
        if (!empty($dados['nr_atendimento'])) {
            $query_inserir = "INSERT INTO cadastros.mapa_internacao_rosa
             (nr_atendimento, nm_paciente, ds_leito, ds_idade, dt_parto, dt_admissao, ds_observacao_aduto, ds_observacao_rn, ds_dieta, ds_fugulin, dt_escalas, dt_sae_rn, nm_usuario, dt_alta, ds_medicamentos,ds_transfusao,ds_procedimentos, ds_alergias,ds_parto,ds_recomendacoes, ds_medicamentosRn,ds_transfusaoRn,ds_procedimentosRn, ds_alergiasRn,ds_recomendacoesRn)
                VALUES 
                (:nr_atendimento, :nm_paciente, :ds_leito, :ds_idade, :dt_parto, :dt_admissao, :ds_observacao_aduto, :ds_observacao_rn, :ds_dieta, :ds_fugulin, :dt_escalas, :dt_sae_rn, :nm_usuario, :dt_alta, :ds_medicamentos,:ds_transfusao,:ds_procedimentos, :ds_alergias,:ds_parto,:ds_recomendacoes,:ds_medicamentosRn,:ds_transfusaoRn,:ds_procedimentosRn, :ds_alergiasRn,:ds_recomendacoesRn)";
