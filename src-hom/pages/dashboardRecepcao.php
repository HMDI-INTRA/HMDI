...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="capacidade-agendada-tab" data-bs-toggle="pill" data-bs-target="#capacidade-agendada" type="button" role="tab" aria-controls="capacidade-agendada" aria-selected="true" title="Pronto atendimento médico">Capacidade x Agendamento</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="perc-absenteismo-tab" data-bs-toggle="pill" data-bs-target="#perc-absenteismo" type="button" role="tab" aria-controls="perc-absenteismo" aria-selected="false" title="Triagem">Taxa Absenteismo</button>
        </li>
       <!--  <li class="nav-item" role="presentation">
          <button class="nav-link" id="taxa-mort-neonatal-tab" data-bs-toggle="pill" data-bs-target="#taxa-mort-neonatal" type="button" role="tab" aria-controls="taxa-mort-neonatal" aria-selected="false" title="Tempo médio de espera">Taxa de mortalidade neonatal</button>
        </li> -->
      </ul>
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="capacidade-agendada" role="tabpanel" aria-labelledby="capacidade-agendada-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-body p-3" id="capacidadeAgendada">
                    <div class="row">
                        <div class="col-2">
                            <label for="dt-inicial" class="form-label">Data inicial:</label>
                            <input type="date" name="dtInicial" class="form-control dtInicial18"/>
                        </div>  
                        <div class="col-2">
                            <label for="dt-final" class="form-label">Data final:</label>
                            <input type="date"  name="dtFinal" class="form-control dtFinal18"/>
                        </div>
                  ...
                  <div class="chart">
                    <div id="chartCapacidadeAgendada"  style="width: 100%; height: 417px;"></div>
                  </div>
                  
                </div>
                <div class="row">
                    <div class="col-6">
                        <label for="tableAnalise18">Análise</label>
                        <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                            <div style="overflow-x: auto;">
                                <table id="tableAnalise18" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                </table>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <label for="planoAcaoResult18">Plano de ação</label>
                        <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                            <div style="overflow-x: auto;">
                                <table id="planoAcaoResult18" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                </table>
                            </div>
                        </div>
                    </div>
          ...
          <div class="tab-pane fade" id="perc-absenteismo" role="tabpanel" aria-labelledby="perc-absenteismo-tab">
            <div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                  <div class="card-body p-3" id="percAbsenteismo">
                  <div class="row">
                        <div class="col-2">
                            <label for="dt-inicial" class="form-label">Data inicial:</label>
                            <input type="date" name="dtInicial" class="form-control dtInicial19"/>
                        </div>  
                        <div class="col-2">
                            <label for="dt-final" class="form-label">Data final:</label>
                            <input type="date"  name="dtFinal" class="form-control dtFinal19"/>
                        </div>
                        <div class="col-2 mt-4 p-1">
                            <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                        </div>  
                    ...
                    <div class="chart">
                      <div id="chartTaxaAbsenteismo"  style="width: 100%; height: 417px;"></div>
                    </div>
                   
                  </div>
                  <div class="row">
                      <div class="col-6">
                          <label for="tableAnalise19">Análise</label>
                          <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                              <div style="overflow-x: auto;">
                                  <table id="tableAnalise19" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                  </table>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-6">
                          <label for="planoAcaoResult19">Plano de ação</label>
                          <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                              <div style="overflow-x: auto;">
                                  <table id="planoAcaoResult19" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                  </table>
                              </div>
                          </div>
                      </div>
          ...
          <!-- <div class="tab-pane fade" id="taxa-mort-neonatal" role="tabpanel" aria-labelledby="taxa-mort-neonatal-tab">
            <div div class="col-lg-12 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                  <div class="card-body p-3" id="taxaMortNeo">
                  <div class="row">
                        <div class="col-2">
                            <label for="dt-inicial" class="form-label">Data inicial:</label>
                            <input type="date" name="dtInicial" class="form-control dtInicial20"/>
                        </div>  
                        <div class="col-2">
                            <label for="dt-final" class="form-label">Data final:</label>
                            <input type="date"  name="dtFinal" class="form-control dtFinal20"/>
                        </div>
                        <div class="col-2 mt-4 p-1">
                            <button class="btn btn-primary btn-gerar">Gerar gráfico</button>
                        </div>  
                    ...
                    <div class="chart">
                      <div id="chartTaxaMortalidadeNeoNatal"  style="width: 100%; height: 417px;"></div>
                    </div>
                    
                  </div>
                  <div class="row">
                      <div class="col-6">
                          <label for="tableAnalise20">Análise</label>
                          <div class="table-responsive p-0 table-common-wrapper" id="tableAnalise_wrapper">
                              <div style="overflow-x: auto;">
                                  <table id="tableAnalise20" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                  </table>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-6">
                          <label for="planoAcaoResult20">Plano de ação</label>
                          <div class="table-responsive p-0 table-common-wrapper" id="planoAcaoResult_wrapper">
                              <div style="overflow-x: auto;">
                                  <table id="planoAcaoResult20" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                                  </table>
                              </div>
                          </div>
                      </div>
                      ...
                      <form id="formAnalise">
                        <div class="row">
                          <div class="col-4 mt-2">
                              ...
                              <input type="text" value = '18' class="form-control" id="solicitacaoTransf" name="solicitacaoTransf" hidden>
                          </div>
                          <div class="col-4">
                          </div>
                          <div class="col-4 mt-2">
                              ...
                              <input type="text" value = '18' class="form-control" id="solicitacaoTransfId" name="solicitacaoTransfId" hidden>
                          </div>
                        </div>
                        <div class="row">
                              <div class="col-12">
                      ...
                      <form id="formAnaliseAgencia">
                        <div class="row">
                          <div class="col-4 mt-2">
                              <label for="mesAno">Mês e ano selecionado:</label>
                              <input type="text" class="form-control" id="mesAno" name="mesAno"  readonly>
                              <input type="text" value = '18' class="form-control" id="solicitacaoTransfIdEdit" name="solicitacaoTransfIdEdit" hidden>
                          </div>
                          <div class="col-4 mt-2">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                      <form id="formRelatorioSolicTransf">
                        ...
                        <div class="form-group">
                            <input type="text" value = '18' class="form-control" id="tela" name="tela" hidden>
                        </div>
                        <div class="form-group">
