                      ...
                      <div class="col-auto">
                        ...
                        <div class="dropdown button-table">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <li><a href="http://10.1.1.108/intranet/src/services/relatorio/xlsx/preventivas.php" class="dropdown-item">Relatório</a></li>
                              <li><a href="http://10.1.1.108/intranet/src/services/relatorio/xlsx/preventivas-vencidas.php" class="dropdown-item">Relatório vencidas</a></li>
                          </ul>
                        </div>
                      </div>
                  </div>
