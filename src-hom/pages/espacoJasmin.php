...
<body class=" bg-gray-100" id="body">
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Espaço Jasmim</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Espaço Jasmim</h6>
        </nav>
        </div>
      </div>
    </nav>
      ...
      <div class="nav-wrapper position-relative end-0">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" >
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="mapa-jasmin-tab" data-bs-toggle="tab" data-bs-target="#mapa-jasmin" type="button" role="tab" aria-controls="mapa-jasmin" aria-selected="true">Mapa de internação</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="ocupacao-jasmin-tab" data-bs-toggle="tab" data-bs-target="#ocupacao-jasmin" type="button" role="tab" aria-controls="ocupacao-jasmin" aria-selected="false">Ocupação hospitalar</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="dnv-jasmin-tab" data-bs-toggle="tab" data-bs-target="#dnv-jasmin" type="button" role="tab" aria-controls="dnv-jasmin" aria-selected="false">DNV</button>
          </li>
        </ul>
        <div class="tab-content" id="ul-navContent">
          <div class="tab-pane fade show active" id="mapa-jasmin" role="tabpanel" aria-labelledby="mapa-jasmin-tab">
            <div class="col-12">
              <div class="card mb-4" style="border-radius: inherit;">
                <div class="card-header pb-0 p-3">
                  <div class="d-flex justify-content-between">
                    <div class="col-auto">
                        <h4 class="mb-2">Mapa de internação Jasmim - <span class="horario"> </span></h4>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                      <button type="button" class="btn btn-block btn-default mb-3" data-bs-toggle="modal" data-bs-target="#modal-mapa-jasmin">Adicionar</button>
                      <div class="dropdown button-table">
                        <button class="btn btn-link text-secondary mb-0" aria-haspopup="true" aria-expanded="false" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                          ...
                          <li><button class="dropdown-item btn-default" data-bs-toggle="modal" data-bs-target="#modalJasmim">Relatório</button></li>
                          </ul>
                      </div>
                    </div>
                </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0 table-common-wrapper" id="tableMapaInternacaoJasmin_wrapper">
                    <div style="overflow-x: auto;">
                        <table id="tableMapaInternacaoJasmin" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                    </div>
                    </div>
                </div>
          ...
          <div class="tab-pane fade" id="ocupacao-jasmin" role="tabpanel" aria-labelledby="ocupacao-jasmin-tab">
            <div class="col-12">
              <div class="card mb-4" style="border-radius: inherit;">
                <div class="card-header pb-0 p-3">
                  <div class="d-flex justify-content-between">
              ...
              <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div style="overflow-x: auto;">
                        <table id="tableOcupacaoJasmim" class="table align-items-center justify-content-center mb-0 table-common" style="width: 100%;">
                        </table>
                    </div>
                    </div>
              </div>
          ...
          <div class="tab-pane fade" id="dnv-jasmin" role="tabpanel" aria-labelledby="dnv-jasmin-tab">
    ...
    <!-- Modal Mapa-->
    <div class="modal fade modal-xl" id="modal-mapa-jasmin" tabindex="-1" role="dialog" aria-labelledby="mapaInternacao" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title font-weight-bolder text-primary text-gradient" id="mapaInternacao">Cadastrar</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="formMapaJasmin">
    ...
    <!-- Modal Editar -->
    <div class="modal fade modal-xl" id="modalMapaJasminEdit" tabindex="-1" role="dialog" aria-labelledby="mapaInternacaoEdit" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form id="formMapaJasminEdit">
              ...
              <div class="row align-items-center mb-2">
                ...
                <div class="col-3" hidden>
                  <label for="ds_medicamentos"></label>
                  <input type="text" id="ds_medicamentos" name="ds_medicamentos" class="form-control" readonly>
                </div>
                <div class="col-3" hidden>
                  <label for="ds_transfusao"></label>
                  <input type="text" id="ds_transfusao" name="ds_transfusao" class="form-control" readonly>
                </div>
                <div class="col-3" hidden>
                  <label for="ds_procedimentos"></label>
                  <input type="text" id="ds_procedimentos" name="ds_procedimentos" class="form-control" readonly>
                </div>
                <div class="col-3" hidden>
                  <label for="ds_alergias"></label>
                  <input type="text" id="ds_alergias" name="ds_alergias" class="form-control" readonly>
                </div>
                <div class="col-3" hidden>
                  <label for="ds_parto"></label>
                  <input type="text" id="ds_parto" name="ds_parto" class="form-control" readonly>
                </div>
              </div>
              <div class="row align-items-center mb-2">
                <div class="col-12">
    ...
    <!-- Modal edit -->
    <div class="modal fade modal-xl" id="modalMapaJasminView" tabindex="-1" role="dialog" aria-labelledby="mapaInternacaoView" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
    ...
    <!-- Relatorio -->
    <div class="col-md-4">
        <div class="modal fade" id="modalJasmim" tabindex="-1" role="dialog" aria-labelledby="modalJasmim" aria-hidden="true">
