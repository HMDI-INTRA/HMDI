        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="col-auto">
                        <h4 class="mb-2">Internação Jasmim</h4>
                    </div>
                    <ul class="navbar-nav ml-auto menu-alertas">
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in alertas-reservas"
                    ...
                    <div class="tab-pane fade show active" id="mapa-jasmin" role="tabpanel" aria-labelledby="mapa-jasmin-tab">
                        ...
                        <div class="card mb-4" style="border-radius: inherit;">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-2">
                                <button type="button" class="btn btn-block btn-default mb-3" data-bs-toggle="modal" data-bs-target="#modalJasmim">Relatório</button>
                                </div>
                            </div>
                        </div>
