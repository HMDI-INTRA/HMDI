...
class View {
    ...
    renderGraficos(data) {
            ...
            columns: [
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="arquivo-cell">
                                <button class="badge-sm btn bg-gradient-info btn-visualizar btn-redondo-pequeno" data-jasmin-id="${row.nr_atendimento}"><i class="ni ni-fat-add"></i></button>
                                ${data}
                            </div>`;
                    },
                },
        ...
        $('#tableAnalise').on('click', '.btn-visualizar', (event) => {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<div class="break-word"> ${observacaoAdulto} <div style='background:#7f3b8a9c;'>${dsMedicamentos}</div> <div style='background:yellow;'>${dsAlergias}</div> <div style='background:red;'>${dsTransfusao}</div> <div style='background:#1070ffdb;'>${ds_procedimento}</div></div>`;
                    }
                }
                ,
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<div class="break-word"> ${observacaoRn} <div style='background:#7f3b8a9c;'>${dsMedicamentosRn}</div> <div style='background:yellow;'>${dsAlergiasRn}</div> <div style='background:red;'>${dsTransfusaoRn}</div> <div style='background:#1070ffdb;'>${ds_procedimentoRn}</div></div>`;
                    }
                },
                {
                    data: 'ds_fugulin',
